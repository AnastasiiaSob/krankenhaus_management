...
public class Qualitaetsmanagementstelle implements Observer{
	...
	public void update(Observable o, Object arg) {
		...
		System.out.println("Qualitaetsmanagementstelle hat die Information erhalten, dass ein "+myAufenthalt.getDauer() +"-Tage Aufenthalt für den Patient "+myAufenthalt.getPatient()+" mit der Patientennummer "+myAufenthalt.getPatient().getId()+" stattgefunden hat.");	
